        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                <div class="col col s4 m4 l4">
                    <img src="<?= $image; ?>" alt="" class="circle responsive-img valign profile-image">
                </div>
...
?>
    <form id ="form" action="routers/order-router.php" method="post">
        <?php
        foreach ($_POST as $key => $value)
        {
        	if(is_numeric($key)){
  ...
  <footer class="page-footer">
    ...
    ================================================ -->
    <script
    src="https://www.paypal.com/sdk/js?client-id=Ad8CT4eXJRbCZe4oaVbS-WQpP6xnF2IYA2GxlGE3vSESxzb596lEItWaSjd2uATNH8LM9iRjs6whTrsm&currency=USD"> // Required. Replace YOUR_CLIENT_ID with your sandbox client ID.
    </script>
