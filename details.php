...
<div>
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/details-router.php" novalidate="novalidate"class="col s12" enctype="multipart/form-data">
                      <div class="row">
              ...
              <div class="row">
                        <div class="input-field col s12">
                        <label for="address" class="">Upload Avatar</label>
